class TestData:
    test_data_user1 = ['Степан', 'Алексеевич', 'Черкизовская, 14', 'Черкизовская', '+79652341364', '09.09.2009',
                       'Для души']

    test_data_user2 = ['Тралл', 'Дуротан', 'Награнд', 'Сокольники', '+78005553535', '11.11.2011',
                       'Воплощение мудрости']
