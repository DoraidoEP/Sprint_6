...
class OrderPage(BasePage):
    ...
    @allure.step('Клик по названию станции метро в выпадающем списке станций метро')
    ...
    @allure.step('Клик по дате в выпадающем календаре поля ввода даты начала аренды')
